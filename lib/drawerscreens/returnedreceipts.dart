...
class ReturnedReceipts extends StatefulWidget {
  const ReturnedReceipts({super.key});

  @override
  State<ReturnedReceipts> createState() => _ReturnedReceiptsState();
}

class _ReturnedReceiptsState extends State<ReturnedReceipts> {
  DateTime? fromDate;
  DateTime? toDate;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Returned Receipts', style: TextStyle(color: primaryColor, fontSize: 18)),
      ),
